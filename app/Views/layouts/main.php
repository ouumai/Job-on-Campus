...
<base href="./" />
		...
		<link href= href="<?= base_url('assets/plugins/global/plugins.bundle.css') ?>" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
									...
									<div class="card card-xl-stretch">
										...
										<div class="card-header align-items-center border-0 mt-4">
											...
											<div class="card-toolbar">
												...
												<!--begin::Menu 1-->
												<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_69981c73d4ef9">
													<!--begin::Header-->
													<div class="px-7 py-5">
														<div class="fs-5 text-gray-900 fw-bold">Filter Options</div>
													</div>
													...
													<div class="px-7 py-5">
														...
														<div class="mb-10">
															...
															<!--begin::Input-->
															<div>
																<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_69981c73d4ef9" data-allow-clear="true">
																	<option></option>
																	<option value="1">Approved</option>
																	<option value="2">Pending</option>
																	<option value="2">In Process</option>
										...
										<div class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
											...
											<div class="d-flex flex-stack flex-wrap flex-grow-1 px-9 pt-9 pb-3">
												<div class="me-2">
													...
													<span class="text-gray-500 fw-bold">Oct 8 - Oct 26 26</span>
												</div>
		...
		<script src= href="<?= base_url('assets/plugins/global/plugins.bundle.js') ?>" ></script>
		<script src= href="<?= base_url('assets/js/scripts.bundle.js') ?>" ></script>
